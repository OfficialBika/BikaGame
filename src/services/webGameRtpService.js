...
const GAME_LABELS = Object.freeze({
  rocket: 'Rocket', slot: 'Premium Slot', plinko: 'Plinko', wheel: 'Lucky Wheel',
  mines: 'Web Mines', blackjack: 'Web Blackjack', shan: 'Shan Koe Mee',
});
...
function cleanGameKey(value) {
  ...
  if (key === 'slot' || key === 'slots' || key === 'webslot') return 'slot';
